...
public class OnlineGameSelectScreen extends AppCompatActivity {
    ...
    private int dir;
    private String gameMode, gameDifficulty, userName = "";
    ...
    private ArrayList<OnlineGameSelectScreen.GameState> childNodes;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnOnExit = findViewById(R.id.btnOnExit);
        ImageView imgOnRestart = findViewById(R.id.imgOnRestart);
        ImageView imgOnBack = findViewById(R.id.imgOnBack);

        btnOnExit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new AlertDialog.Builder(OnlineGameSelectScreen.this)
        ...
        gameDifficulty = i.getStringExtra("Difficulty");
     ...
     */
        ...
        for (String fromCoords : movablePieces) {
            ...
            for (String toCoords : destinationSquares) {
                ...
                for (GameState finalChild : currentChildNodes) {
                    ...
                    Log.e("Piece_Info", String.valueOf(moveNum++));
                    int count = 1;
                    for (String piece : finalChild.redPieces) {
                        Log.e("Red_Piece_" + count++, Character.getNumericValue(piece.charAt(1)) + ", " + Character.getNumericValue(piece.charAt(3)));
                    }
                    count = 1;
                    for (String piece : finalChild.whitePieces) {
                        Log.e("White_Piece_" + count++, Character.getNumericValue(piece.charAt(1)) + ", " + Character.getNumericValue(piece.charAt(3)));
                    }
                    count = 1;
                    for (String king : finalChild.kings) {
                        Log.e("King_Piece_" + count++, Character.getNumericValue(king.charAt(1)) + ", " + Character.getNumericValue(king.charAt(3)));
                    }
                    Log.e("Piece_Turn", "" + finalChild.currentColor);
        ...
        Log.e("NodeDepth", String.valueOf(depth));
        Log.e("NodeValue", String.valueOf(bestGameValue));
    ...
    private void gameOver() {
        ...
        String winningColors = (currentColor == 'R') ? "White" : "Red";
        char colormatch;
        if(winningColors.equals("White")){
            colormatch = 'W';
        }else{
            colormatch = 'R';
        }
        ...
        String winnermsg;
        boolean checkifUserExist = helper.Exists(userName);
        if(colormatch == playerColor){
            winnermsg = "Congratulation, You have Won!!";

            if(gameDifficulty.equals("Easy")){
                if(checkifUserExist){
                    ArrayList<DBObjects> getAllUserData = helper.getData();
                    for(int i = 0; i < getAllUserData.size(); i++){
                        if(getAllUserData.get(i).getName().equals(userName)){
                            helper.updateName(userName, getAllUserData.get(i).getEasyWin() + 1, getAllUserData.get(i).getEasyLose(),
                                    getAllUserData.get(i).getMediumWin(), getAllUserData.get(i).getMediumLose(), getAllUserData.get(i).getHardWin(), getAllUserData.get(i).getHardLose());
                        }
                    }
                }else{
                    helper.insertDataSave(userName, 1,0,
                            0, 0, 0, 0);
                ...
                if(checkifUserExist){
                    ...
                    for(int i = 0; i < getAllUserData.size(); i++){
                        if(getAllUserData.get(i).getName().equals(userName)){
                            helper.updateName(userName, getAllUserData.get(i).getEasyWin() , getAllUserData.get(i).getEasyLose(),
                                    getAllUserData.get(i).getMediumWin() + 1, getAllUserData.get(i).getMediumLose(), getAllUserData.get(i).getHardWin(), getAllUserData.get(i).getHardLose());
                        }
                    }
                }else{
                    helper.insertDataSave(userName, 0,0,
                            1, 0, 0, 0);
                ...
                if(checkifUserExist){
                    ...
                    for(int i = 0; i < getAllUserData.size(); i++){
                        if(getAllUserData.get(i).getName().equals(userName)){
                            helper.updateName(userName, getAllUserData.get(i).getEasyWin() , getAllUserData.get(i).getEasyLose(),
                                    getAllUserData.get(i).getMediumWin(), getAllUserData.get(i).getMediumLose(), getAllUserData.get(i).getHardWin()+ 1, getAllUserData.get(i).getHardLose());
                        }
                    }
                }else{
                    helper.insertDataSave(userName, 0,0,
            ...
            winnermsg = "Too Bad, AI won this round. Goodluck on next game!";
            if (gameDifficulty.equals("Easy")) {
                if (checkifUserExist) {
                    ArrayList<DBObjects> getAllUserData = helper.getData();
                    for (int i = 0; i < getAllUserData.size(); i++) {
                        if (getAllUserData.get(i).getName().equals(userName)) {
                            helper.updateName(userName, getAllUserData.get(i).getEasyWin(), getAllUserData.get(i).getEasyLose() + 1,
                                    getAllUserData.get(i).getMediumWin(), getAllUserData.get(i).getMediumLose(), getAllUserData.get(i).getHardWin(), getAllUserData.get(i).getHardLose());
                        }
                    }
                } else {
                    helper.insertDataSave(userName, 0, 1,
                            0, 0, 0, 0);
                ...
                if (checkifUserExist) {
                    ...
                    for (int i = 0; i < getAllUserData.size(); i++) {
                        if (getAllUserData.get(i).getName().equals(userName)) {
                            helper.updateName(userName, getAllUserData.get(i).getEasyWin(), getAllUserData.get(i).getEasyLose(),
                                    getAllUserData.get(i).getMediumWin(), getAllUserData.get(i).getMediumLose() + 1, getAllUserData.get(i).getHardWin(), getAllUserData.get(i).getHardLose());
                        }
                    }
                } else {
                    helper.insertDataSave(userName, 0, 0,
                ...
                if (checkifUserExist) {
                    ...
                    for (int i = 0; i < getAllUserData.size(); i++) {
                        if (getAllUserData.get(i).getName().equals(userName)) {
                            helper.updateName(userName, getAllUserData.get(i).getEasyWin(), getAllUserData.get(i).getEasyLose(),
                                    getAllUserData.get(i).getMediumWin(), getAllUserData.get(i).getMediumLose(), getAllUserData.get(i).getHardWin(), getAllUserData.get(i).getHardLose() + 1);
                        }
                    }
                } else {
                    helper.insertDataSave(userName, 0, 0,
